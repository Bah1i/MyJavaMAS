...
public class CoordinatorAgentDF extends Agent {
    ...
    protected void setup() {
        logger.info("Coordinator DF agent " + getLocalName() + " is ready.");

        // Периодическое обновление списка вычислителей каждые 5 секунд
